...
package_exists <- F  # turn this on after you've built functionality and package
print_reports <- F
build_package <- T
exit_before_packaging_steps <- T
...
If you would like to use ggnorthcarolina as a template, click "Use this template" ->
